...
// ─── Component ─────────────────────────────────────────────────────────────────
/**
 * Na traci koju svetla sekcija seče kroz kljun, u dizajnu vrh kljuna viri ispod
 * te ivice, preko svetle podloge. Sam crtež to ne može — sekcija ga prekriva —
 * pa se kljun ponavlja kao zaseban sloj iznad nje. Isti oblik i ista boja, pa se
 * šav ne vidi.
 *
 * Sloj se uvek ispisuje, a `global.css` ga prikazuje samo tamo gde sova zaista
 * biva presečena: na niskoj traci na svakoj širini, i na visokoj traci na
 * telefonu, gde se sova takođe spušta preko donje ivice. Ranije je odluku
 * donosio prop, pa se na telefonu nije mogla razlikovati od desktopa.
 */
