    ...
    <div className='w-full mx-auto 2xl:max-w-screen-2xl 2xl:mx-auto header-container'>
      <div className='header-subcontainer'>
        <button
          ...
          className="inline-flex items-center justify-center pb-2 px-2 text-black-400 transition duration-150 ease-in-out xl:hidden"
        >
          <svg
            className="h-6 w-6"
            stroke="currentColor"
        ...
        <div className="flex items-center">
          ...
          {!loading && (
            <>
            <div className="hidden xl:flex lg:gap-7"></div>
            {!openMenu && (
              <div className="hidden xl:flex lg:gap-7 header-items-list">
