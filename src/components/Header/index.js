...
const Header = ({bgColor = '#261A54'}) => {
  ...
  return (
    <div  className="flex justify-between items-center w-full fixed left-0 flex justify-center bg-[#261A54] z-[55] nnb-header" style={{display: display ? 'flex' : 'none', left: '0'}}>
